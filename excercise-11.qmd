...
```{r, message=FALSE, warning=FALSE}
m2_life    <- lm(max_life_mo ~ gestation_mo + newborn_g + weaning_mo + wean_mass_g + litters_per_year + mass_g, data = d4, na.action = na.exclude)

summary(m2_life)

m2_afr    <- lm(AFR_mo ~ gestation_mo + newborn_g + weaning_mo + wean_mass_g + litters_per_year + mass_g, data = d4, na.action = na.exclude)
